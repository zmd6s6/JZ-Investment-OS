...
Implement PR-04: immutable Thesis create/version/diff, controlled Evidence impact, monitoring and
invalidation conditions, time-travel reads, and synthetic S5 regression coverage. PR-00 through
PR-03 are accepted and merged to `main`.
...
| PR-04 | IN_PROGRESS | Pending | Thesis and shared memory |
